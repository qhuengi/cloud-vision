...
def brThreshold(image, threshold=0.25):
    """Thresholds image by normalized blue/red ratio (see Li et al., 2011).
    ...
    ret, thresh = cv.threshold(mapped, threshold, 1, cv.THRESH_BINARY)
    return thresh
